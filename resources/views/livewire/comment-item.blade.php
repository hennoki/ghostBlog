<div class="flex justify-between mb-4 gap-3">
    ...
    <div class="flex-1">
        ...
        <div class=" mb-4 gap-3">
            <a wire:click.prevent='startReply' href="#" class="text-sm text-teal-600 mr-3">Reply</a>

            @if (\Illuminate\Support\Facades\Auth::id() == $comment->user_id)
                <a wire:click.prevent='startCommentEdit' href="#" class="text-sm text-blue-600 mr-3">Edit</a>
                <a wire:click.prevent='deleteComment' href="#" class="text-sm text-red-600 mr-3">Delete</a>
            @endif
        </div>
