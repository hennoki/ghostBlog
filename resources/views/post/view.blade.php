    ...
    <div class="flex">
        <section class="w-full md:w-2/3  flex flex-col px-3">
            ...
            <article class="flex flex-col shadow my-4">
                ...
                <div class="bg-green-500 flex flex-col justify-start p-6">
            ...
            <div class="w-full flex pt-6 mb-3">
                <div class=" w-1/2">

                    @if ($prev)
                        <a href="{{ route('view', $prev) }}"
                            class="block w-full bg-green-500 shadow hover:shadow-md text-left p-6">
                ...
                <div class=" w-1/2">
                    @if ($next)
                        <a href="{{ route('view', $next) }}"
                            class="block w-full bg-green-500 shadow hover:shadow-md text-right p-6">
